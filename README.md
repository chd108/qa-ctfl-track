...
**Technik:** `base.css` bildet die visuelle Basis für die Hauptseiten. Die HA5-Formularseiten (Testkonzept, Testfallentwurf) nutzen `formular-base.css` (A4-Layout, Druckregeln, Nav, Skip-Link, page-footer); Nav/Skip-Link werden beim Druck ausgeblendet. Meta-Descriptions und semantische Struktur (`<main>`, `id="main"`) sind umgesetzt.
