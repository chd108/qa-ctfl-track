...
Letzte Aktualisierung: 2026-04-11 — **QA_Lernwebseite** — IA **Lernzusammenfassung**: **dritte** Kopf-**`<nav>`** (`main-nav--summary`), **`index.html`** dritte Kartenzeile, **`pages/07-lernzusammenfassung.html`**; **03_Project_Standards** §6/§7 und diese Datei (Dashboard §1, Meilenstein §2) nachgezogen. Zuvor **2026-04-05** **`04e-ha3-ueberdeckung.html`** nach **HA3-Pilot**; **README**, **pilot-ha3-…**, **03** §6, **P03** §2. Zuvor **2026-04-04** **HA3** Content-Pilot / **`assets/ha3-svg/`**; ältere Meilensteine siehe §2.  
...
| **Website *QA_Lernwebseite*** | **Technische Basis abgeschlossen** — einheitliches Hauptsystem, `index.html` als alleiniger Einstieg, Benennungslogik inkl. Matrix für aktive Seiten umgesetzt; **Kopfnavigation (Stand 2026-04-02, ergänzt 2026-04-11):** **Startseite** als **Logo** im ersten Listenpunkt der **Lernmaterial**-Nav (Favicon-Asset, **`--nav-inline-logo-height`**), kein zweites Logo links außerhalb der Leisten; **seit 11.04.2026** **dritte Nav-Leiste** *Lernzusammenfassung* (`main-nav--summary`) und **dritte Kartenzeile** auf **index** (Start: **`07-lernzusammenfassung.html`**); **Designsystem-Pilot:** **F-META** / **F-LEGEND** / **F-CHAIN** (Dokumentenkette, **creme/pastell**, **04d** B.13) / Korrekturkomponenten in **`base.css`**, **meta-bar** auf **11** Kernseiten; **K-Stufen**-Kurzzeile im **Hinweis** nur wenn die **meta-bar** bereits **(K1)/(K2)/(K3)** oder **FL-… K1/K2/K3** enthält (**9** Seiten); **SDLC**-Seiten **02a/02b** mit Triptych-Layout und **1400px** Inhaltsbreite. |
...
- **Navigation:** **`base.css`** — **`.main-nav--summary`**; **`index.html`**, **`pages/*.html`**, **`templates/referenzvorlage-hauptsystem.html`** — **dritte** `<nav>` unter **Lernmaterial** / **Hausaufgaben** (`aria-label="Lernzusammenfassung"`).  
...
- **Seite:** [`07-lernzusammenfassung.html`](../02_Portfolio/QA_Lernwebseite/pages/07-lernzusammenfassung.html) — Hauptsystem (Skip-Link, **page-chrome**, **meta-bar**, Footer); **inhaltlich** Sidebar + Kapitelkarten unverändert.  
