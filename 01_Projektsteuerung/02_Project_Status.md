...
Letzte Aktualisierung: 2026-04-02 — **Workshop-Dateien** nach Konvention **P01/IST/P04/P05** umbenannt; **alle** Repo-Verweise nachgezogen; **Designsystem-Workshop:** [README.md](designsystem-workshop/README.md) (Einstieg), **Metablock** aller `.md`, **Rollout** Phase A/B, **Phase 3** (P0/P1, **F-LEGEND** in **04b**, §6 **03**); **Aufräum-Plan** (Dateireduktion optional) im [README](designsystem-workshop/README.md) (*Abschnitt Aufräum-Plan*); zuvor **QA_Lernwebseite** Kopfnavigation **`95d6f18`**; 2026-03-31 **Pilot CSS** **F-META** / **F-LEGEND** … siehe §2)  
...
| **Nächster Schwerpunkt** | **Zwei Spuren:** (1) **Workshop-Doku** — Living Docs, Konsolidierung **03↔04a–c**, **Rollout**; **optional** weitere **Dateireduktion** / Zusammenlegen (siehe [README](designsystem-workshop/README.md) — Abschnitt *Aufräum-Plan*). (2) **Website/CSS** — **Komponentenstil / Designsystem light**: **Pilot** (**F-META**, **F-LEGEND**, Korrekturleiste) **in `base.css` umgesetzt** (siehe **04d B.10/B.11/B.12**, **04b** *Umsetzungsstand*). **Nächste CSS-Iteration:** Abbau von Inline-CSS wo sinnvoll, **Callout**-Familien (**F-CHAIN** …) nach Priorität **04b** und **Rollout Phase A** (Lerninhalte zuerst); bei Bedarf Regeln in [03_Project_Standards.md](03_Project_Standards.md) (Abschn. 6); **IST→SOLL→Token** [P03-mapping-ist-soll-token.md](designsystem-workshop/P03-mapping-ist-soll-token.md). |
...
- **Offen (bewusst):** starke **Dateireduktion** (Zusammenlegen von Dateien, Umbenennung) — **Aufräum-Plan** im [README](designsystem-workshop/README.md) (*Abschnitt Aufräum-Plan*); **kein** zusätzlicher CSS-Umfang in dieser Arbeitspaket-Linie.

- **In Klartext:** Der Workshop-Ordner ist **besser lesbar und konsistenter** (Köpfe, eine gemeinsame Sprache für **Prio**, klarer **Rollout**). **Noch nicht** „aufgeräumt“ im Sinne von **weniger Dateien** — das ist **optional** und steht im **Aufräum-Plan**.
