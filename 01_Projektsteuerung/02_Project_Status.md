...
Letzte Aktualisierung: 2026-04-02 — **Aufräum-Plan Phase 4 abgeschlossen:** **B** (Zusammenlegen **P04-01–03**) **bewusst verworfen** — [README](designsystem-workshop/README.md) (*Abschnitt Aufräum-Plan*); zuvor **Workshop-Dateien** **P01/IST/P04/P05**, Repo-Verweise, **Designsystem-Workshop**-README (Einstieg, Metablock, Rollout, Phase 3); **QA_Lernwebseite** Kopfnavigation **`95d6f18`**; 2026-03-31 **Pilot CSS** **F-META** / **F-LEGEND** … siehe §2)  
