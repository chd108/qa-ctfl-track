...
Letzte Aktualisierung: 2026-04-02 (**Design-Taxonomie** definiert, **Pilot-Phase**; [03-token-mapping-2026-04-01.md](designsystem-workshop/03-token-mapping-2026-04-01.md))  
...
| **Nächster Schwerpunkt** | **Komponentenstil / Designsystem light** — **Design-Taxonomie definiert (Pilot-Phase):** **SOLL** (C/F/S/P) und **IST→SOLL→Token-Mapping** in [03-token-mapping-2026-04-01.md](designsystem-workshop/03-token-mapping-2026-04-01.md); **konzeptionelle Basis** im Ordner **`01_Projektsteuerung/designsystem-workshop/`** (Sessions **1**–**2f**). **Nächster Schritt:** **Pilot** — ausgewählte Token-Familien in **`base.css`** / **`doc-a4.css`** verankern und **anpassen**. Verankerung in [03_Project_Standards.md](03_Project_Standards.md) (Abschn. 6) **ergänzt**; **Charter** bei Bedarf nach **Pilot-Abschluss**. |
...
Technische Basis und Benennungsmatrix der *QA_Lernwebseite* gelten als **abgeschlossen**; die HA4/HA5-Strecke ist **inhaltlich** durch die Phasen 1–4 **abgedeckt**. **P1:** **Design-Taxonomie** und **Token-Mapping** sind **schriftlich festgelegt** — **Pilot-Phase** testet nun **1–2 Token-Familien** (z. B. Chips / Callouts) **live** im CSS; **kein** vollständiges Umbenennen aller Klassen vor dem Pilot.
...
|-------------|-------------------------|
| **2026-04-02** | **Design-Taxonomie definiert (Pilot-Phase):** [03-token-mapping-2026-04-01.md](designsystem-workshop/03-token-mapping-2026-04-01.md) — IST→SOLL→Token über **C-/F-/P-/S-***; **ca. 15–30** konsolidierte CSS-Variablen **Zielgröße**; **Workshop-Ordner** bleibt **Referenz**; **Umsetzung** im Stylesheet = **Pilot**, nicht Abschluss. |
