...
- **Nachwirkung für P1:** Ausgang für **Design-Tokens** und **IST→SOLL-Mapping** ist **geschärft**; [website-analyse-2026-03-28.md](../02_Portfolio/QA_Lernwebseite/website-analyse-2026-03-28.md) bleibt **IST/Roadmap**-Komplement; Workshop liefert **Semantik- und SOLL-Raster**.
  - *Einfach gesagt:* Für P1 (Designsystem light) ist die Ausgangslage geschärft: Session 3 kann Design-Tokens und IST→SOLL-Mapping angehen. Die website-analyse-2026-03-28.md (unter 02_Portfolio/QA_Lernwebseite/) bleibt IST und Roadmap der Website; der Workshop liefert dazu das Semantik- und SOLL-Raster — beides ergänzt sich, ersetzt sich nicht.
...
- **IST (Website, Meta):** [website-analyse-2026-03-28.md](../02_Portfolio/QA_Lernwebseite/website-analyse-2026-03-28.md) — Stichproben, Roadmap, priorisierte Verbesserungen.  
- **IST (Seiten, technisch):** [komponenten-analyse-2026-03-30.md](../02_Portfolio/QA_Lernwebseite/komponenten-analyse-2026-03-30.md); Seitenmatrix [02c](designsystem-workshop/02c-vollstaendige-seitenmatrix-2026-03-30.md).  
...
1. **P1 — Designsystem light:** **Session 3** starten — **Token-Liste** und **IST→SOLL-Mapping** (basierend auf **02f**, **02c**, **komponenten-analyse**); **Pilot** (z. B. Callout-Familie + Chip-Skala). **[03_Project_Standards.md](03_Project_Standards.md)** (Abschn. 6 ff.) und **[01_Project_Charter.md](01_Project_Charter.md)** nachziehen, sobald **kanonische** Komponenten/Token **feststehen**. **IST:** [website-analyse-2026-03-28.md](../02_Portfolio/QA_Lernwebseite/website-analyse-2026-03-28.md) weiterhin gültig.  
