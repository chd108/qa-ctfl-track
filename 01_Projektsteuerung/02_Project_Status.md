...
Letzte Aktualisierung: 2026-04-05 — **QA_Lernwebseite** **`04e-ha3-ueberdeckung.html`** nach **HA3-Pilot** (**0–6**, **`ha3p-*`**, zweispaltige **Lösung**); Steuerung/Doku nachgezogen (**README**, **pilot-ha3-…**, **03_Project_Standards** §6, **P03** §2). Zuvor **2026-04-04** **HA3 Content-Pilot**, SVG **`assets/ha3-svg/`**; davor **2026-04-03** Landkarte **Praxis-/Syllabus-Feinschnitt**; zuvor Kopf **5.3** siehe §2  
